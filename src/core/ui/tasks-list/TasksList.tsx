...
function TasksList({ tasks, initialFilter = '' }: Props) {
  ...
  useInput((input, key) => {
    ...
    if (input === 'G') {
      ...
      setSelectedIndex(Math.min(ITEMS_PER_PAGE - 1, filteredTasks.length - startIndex - 1))
      return
    }
        ...
        <Box flexDirection="column" width="100%">
          ...
          {currentTask && (
            <Box marginTop={1}>
              ...
              <Text dimColor> • </Text>
              <Text color="gray">{currentTask.manager.getTitle().description}</Text>
            </Box>
          )}
        </Box>
      </Box>
          ...
          >
            ...
            <Box marginTop={1} flexDirection="column">
              ...
              <Box marginTop={1}>
                ...
                <Text color="yellow">{currentTask.manager.getTitle().name}</Text>
              </Box>
            </Box>
          </Box>
        )}
