...
import { WorkspaceProject } from '../../../types/index.js'
...
function ProjectsList({ projects, onSelect }: Props) {
  ...
  useInput((input, key) => {
    ...
    if (input === 'G') {
      ...
      setSelectedIndex(Math.min(ITEMS_PER_PAGE - 1, filteredProjects.length - startIndex - 1))
      return
    }
            ...
            <>
              ...
              {totalPages > 1 && (
                <Box marginTop={1} justifyContent="center">
                  <Text color="gray">
                    Page {currentPage + 1}/{totalPages} • {filteredProjects.length}{' '}
                    projects
                  </Text>
                </Box>
              )}
